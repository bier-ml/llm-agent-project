...
def send_welcome(message):
    bot.reply_to(message, 'Hello! Use /price <id> to get daily price data, e.g., /price hamster')
...
def send_price(message):
    try:
        ...
        bot.reply_to(message, "Please specify a cryptocurrency id, e.g., /price hamster.")
        return
